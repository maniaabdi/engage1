...
struct req_state {
	...
	~req_state();
	int get_req_info(string dest, string &uri, string &auth_token); /* engage1 */
	int submit_http_req(string dest, off_t obj_ofs, size_t len, off_t read_ofs, void* args, size_t (*write_cb)(void *, size_t, size_t, void *));  /* engage1 */
};
