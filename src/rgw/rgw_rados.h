...
*/
	...
	class RGWRados
	{
		...
		/*engage1*/
		//virtual void cache_writethrough(bufferlist bl, int len, std::string obj_key) {}
		//virtual bool hit_local_cache(string oid){ return false; }
		//virtual int cache_io_read(bufferlist *bl, int len, std::string oid){return 0;}
		//virtual int cache_aio_read(struct librados::cacheAioRequest *cc);
		//virtual int cache_hash_uir(string uri) {return 0};
		//virtual int cache_remote_io(string uri) {return 0};
		/*engage1*/
